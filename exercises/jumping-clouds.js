...
// Knowing that we are always want to jump as far as we can and max jump length is i + 2 we are performing a check if c[i+2] !== 0 then we jump 1 step forward otherwise 2 steps
